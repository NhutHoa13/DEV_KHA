...
import 'package:flutter_application_1/Screen/chucnang/page_update_avatar.dart';
...
class DoianhScreen extends StatefulWidget {
  ...
  static void nextPage(
      BuildContext context, PageUpdateAvatar pageUpdateAvatar) {}
}
                  ...
                  for (var i = 1; i < 5; i++) ...{
                    Column(
                      children: [
                        ...
                        TextButton.icon(
                            onPressed: () {
                              DoianhScreen.nextPage(
                                  context, PageUpdateAvatar());
                            },
